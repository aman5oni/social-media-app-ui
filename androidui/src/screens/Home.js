...
const Home = ({ navigation }) => {
  ...
  const onTabPressed = () => {
    setState({ popularSelected: !state.popularSelected });
  };
      ...
      >
        ...
        >
          <TouchableOpacity
            ...
            style={{
              borderBottomColor: state.popularSelected ? "#044244" : "#FFF",
              borderBottomWidth: 4,
              paddingVertical: 6
            }}
          >
            <Text
              style={{
                color: state.popularSelected ? "#044244" : "#9ca1a2"
              }}
            >
              MOST POPULAR
            </Text>
          ...
          <TouchableOpacity
            onPress={onTabPressed}
            style={{
              borderBottomColor: state.popularSelected ? "#FFF" : "#044244",
              borderBottomWidth: 4,
              paddingVertical: 6,
              marginLeft: 30
            }}
          >
            <Text
              style={{
                color: state.popularSelected ? "#9ca1a2" : "#044244"
              }}
            >
              RECENT
            </Text>
